sap.ui.define([
    ...
    return BaseController.extend("sap.ui.demo.webapp.controller.QM.QMOperation", {
        onInit: function () {
            //jQuery.sap.getUriParameters().get("Plant")
            var oRouter = this.getRouter();
            oRouter.getRoute("QMOperation").attachMatched(this._onRouteMatched, this);
        },
        ...
        onQMOrderOperation: function (oEvent) {
            ...
            });console.log(oCtx.getProperty("NUM_ORDEN"),oCtx.getProperty("OPERACION"),oCtx.getProperty("LOTE"),);
        },
