sap.ui.define([
    ...
    return BaseController.extend("sap.ui.demo.webapp.controller.Mantenimiento.Ordenes.detalleOperacion", {
        ...
        _onRouteMatched: function (oEvent) {
            ...
            this._base_onloadHeader(aData, "GIM/DatosTransaccionales/Mantenimiento/Orden/Visualizar/Transaction/get_operation", "Cabecera");
        },
        ...
        onOpenDialogAddComponent: function () {
            ...
            //this._base_onloadCOMBO("material_addOperation", oData, "EquipandoXXI/DatosTransaccionales/Mantenimiento/Orden/Crear/Transaction/get_materials_byType", "","Materiales");
        ...
        onCloseDialogAddComponentConfirm: function (oEvent) {
            ...
            this.addComponent(oData, 'GIM/DatosTransaccionales/Mantenimiento/Orden/Crear/Transaction/add_component');
        },
                ...
                .done(function (xmlDOM) {
                    ...
                    if (opElement.firstChild != null) {
                        ...
                        if (aData[0].error !== undefined) {
                            ...
                            oThis._base_onloadTable("PMComponentList", xData, "GIM/DatosTransaccionales/Mantenimiento/Orden/Visualizar/Transaction/get_components", "Componentes", "");
                        }
        ...
        onOpenDialogAddNotification: function (oEvent) {
            ...
            this._base_onloadCOMBO("listPMDesviacion", oAData, "GIM/DatosMaestros/Mantenimiento/Desviaciones/Transaction/get_desv", "Desviaciones");
            this._base_onloadCOMBO("workCenter_list", oAData, "GIM/DatosMaestros/Produccion/CentroTrabajo/Transaction/get_workCenter", oCtx.getProperty("work_center"), "Centro Trabajo");
        ...
        onCloseDialogAddNotificationConfirm: function (oEvent) {
            ...
            if (descOperation.getValue() === '') {
                ...
                console.log(oData);
                this.createNotification(oData, 'GIM/DatosTransaccionales/Mantenimiento/Orden/Notificar/Transaction/notification');
            }
                ...
                .done(function (xmlDOM) {
                    ...
                    if (opElement.firstChild !== null) {
                        ...
                        if (aData[0].error !== undefined) {
                            ...
                            oThis._base_onloadHeader(xData, "GIM/DatosTransaccionales/Mantenimiento/Orden/Visualizar/Transaction/get_operation", "Cabecera");
                            oThis.getOwnerComponent().openHelloDialog(aData[0].error);
                        }
                        else {
                            //Create  the JSON model and set the data                                                                                                
                            ...
                            oThis._base_onloadHeader(yData, "GIM/DatosTransaccionales/Mantenimiento/Orden/Visualizar/Transaction/get_operation", "Cabecera");
                        }
        ...
        onOpenDialogAddConsumption: function (oEvent) {
            ...
            this.createConsumption(oData, 'GIM/DatosTransaccionales/Mantenimiento/Orden/Consumos/Transaction/consumption');
        },
                ...
                .done(function (xmlDOM) {
                    ...
                    if (opElement.firstChild != null) {
                        ...
                        if (aData[0].error !== undefined) {
                            ...
                            oThis._base_onloadTable("PMComponentList", oData, "GIM/DatosTransaccionales/Mantenimiento/Orden/Visualizar/Transaction/get_components", "Componentes", "");
                        }
