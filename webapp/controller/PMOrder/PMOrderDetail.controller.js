sap.ui.define([
    ...
    return BaseController.extend("sap.ui.demo.webapp.controller.PMOrder.PMOrderDetail", {
        onInit: function () {
            //jQuery.sap.getUriParameters().get("Plant")
            var oRouter = this.getRouter();
            oRouter.getRoute("PMOrderDetail").attachMatched(this._onRouteMatched, this);            
        },
        ...
        _onRouteMatched: function (oEvent) {
            ...
            this._base_onloadHeader(aData, "SelloRojo/DatosTransaccionales/Mantenimiento/Orden/Visualizar/Transaction/visualizar_orden","Cabecera");
            this._base_onloadTable('PMOperationList', aData, 'SelloRojo/DatosTransaccionales/Mantenimiento/Orden/Cabecera/Transaction/get_operations',"Operaciones","");
        },
        ...
        onOpenDialogAddOperation : function (oEvent) {
            ...
            this._base_onloadCOMBO("workCenter_list", oData, "SelloRojo/DatosMaestros/Produccion/CentroTrabajo/Transaction/get_workCenter", oCtx.getProperty("work_center"), "Centro Trabajo");
            ...
            MessageBox[sMessageBoxType](sMessage, {
                ...
                onClose: function (oAction) {
                    if (oAction === MessageBox.Action.YES) {
                        oThis.changeOrderStatus(oData, 'SelloRojo/DatosTransaccionales/Mantenimiento/Orden/Cerrar/Transaction/cerrar_orden');
                    }
                }.bind(this)
            });
        },
        ...
        onCloseDialogAddOperationConfirm: function (oEvent) {
            ...
            if (descOperation.getValue() == '')
                ...
                console.log(oData);
                this.createPMOperation('PMOrderOperation', oData, 'SelloRojo/DatosTransaccionales/Mantenimiento/Orden/Crear/Transaction/add_operation');
            }
                ...
                .done(function (xmlDOM) {
                    ...
                    if (opElement.firstChild != null) {
                        ...
                        if (aData[0].error !== undefined) {
                            ...
                            oThis._base_onloadTable('PMOperationList', aData, 'SelloRojo/DatosTransaccionales/Mantenimiento/Orden/Cabecera/Transaction/get_operations', "Operaciones", "");
                        }
        ...
        onOpenDialogRelease: function (oEvent) {
            ...
            this.changeOrderStatus(oData, 'SelloRojo/DatosTransaccionales/Mantenimiento/Orden/Liberar/Transaction/liberar_orden');
        },
        ...
        onPMOrderOperation: function (oEvent) {            
            ...
            this.getRouter().navTo("PMOrderOperation", {
                order: oCtx.getProperty("order"),
        ...
        _MessageBoxChangeOrderEstatus: function (sMessage, sMessageBoxType, oData, oThis) {
            MessageBox[sMessageBoxType](sMessage, {
                ...
                onClose: function (oAction) {
                    if (oAction === MessageBox.Action.YES) {
                        oThis.changeOrderStatus(oData, 'SelloRojo/DatosTransaccionales/Mantenimiento/Orden/Estatus/Transaction/user_status');
                    }
                }.bind(this)
            });
        },
                ...
                .done(function (xmlDOM) {
                    ...
                    if (opElement.firstChild != null) {
                        ...
                        if (aData[0].error !== undefined) {
                            ...
                            oThis._base_onloadHeader(aData, "SelloRojo/DatosTransaccionales/Mantenimiento/Orden/Visualizar/Transaction/visualizar_orden", "Cabecera");
                        }
